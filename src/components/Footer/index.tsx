  ...
  return (
    <footer className="relative z-10 bg-white pt-16 dark:bg-gray-dark md:pt-20 lg:pt-24">
      <div className="container">
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
            <div className="mb-12 flex max-w-[360px] flex-col justify-center lg:mb-16">
              <Link href="/" className="mb-8 inline-block">
                <div className="relative w-[90px] h-[90px] bg-black rounded-full mx-auto dark:hidden sm:mx-0">
                  <Image src="/images/logo/logo.png" alt="logo" className="" fill style={{ objectFit: "cover" }} />
                </div>
                <div className="relative w-[90px] h-[90px] bg-black rounded-full mx-auto hidden dark:block sm:mx-0">
                  <Image src="/images/logo/logo.png" alt="logo" className="" fill style={{ objectFit: "cover" }} />
                </div>
              </Link>
              <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">The Home of Science Council of IISERB</p>
              <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:justify-normal sm:space-x-4 sm:space-y-0">
                <Link href={"https://www.instagram.com/science_council_iiserb/"}>
                  <button
                    type="button"
                ...
                <Link href="mailto:sciencecouncil@iiserb.ac.in">
                  <button
                    type="button"
                    data-twe-ripple-init
                    data-twe-ripple-color="light"
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="mb-12 lg:mb-16">
              ...
              <ul>
                ...
                <li>
                  <Link href="/#clubs" className="mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary">
                    Clubs & Fests
                  </Link>
                </li>
                <li>
                  <Link href="/#members" className="mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary">
                    Members
                  </Link>
                </li>
              </ul>
        ...
        <div className="py-8">
          <p className="text-center text-base text-body-color dark:text-white">© 2024 Science Council, IISERB</p>
        </div>
      </div>
