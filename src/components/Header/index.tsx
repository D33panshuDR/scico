  ...
  return (
    <header
      className={`header left-0 top-0 z-40 flex w-full items-center ${
        sticky ? "fixed z-[9999] bg-white !bg-opacity-80 shadow-sticky backdrop-blur-sm transition dark:bg-gray-dark dark:shadow-sticky-dark" : "absolute bg-transparent"
      }`}
    >
      <div className="container">
        <div className="relative -mx-4 flex items-center justify-between">
          <div className="w-30 h-30 px-4 xl:mr-12">
            <Link href="/" className={`header-logo block w-full ${sticky ? "py-5 lg:py-2" : "py-8"} w-30 h-30 relative`}>
              <div className="w-[90px] h-[90px] bg-black rounded-full">
                <Image src="/images/logo/logo.png" alt="logo" fill style={{ objectFit: "contain" }} />
              </div>
              {/* <Image
