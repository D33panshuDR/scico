        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto max-w-[800px] text-center">
              <h1 className="hover:light:text-transparent mb-5 bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 bg-clip-text text-3xl font-bold leading-tight text-black transition duration-300 ease-in-out hover:scale-110 dark:text-white  hover:dark:text-transparent sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
